...
this.isenabled=true
  ...
  presentConfirm7()
  {
    let alert = this.Alert.create({
      title: 'حاسبه تمويل',
      message: 'يجب الا يزيد مجموع القسط الشهري مع الالتزامات عن نسبه 45% من الراتب الاساسي . يرجي اعاده البيانات المدخله او الاتصال علي قسم المبيعات 0590993939-0112456999',
      buttons: [
        {
          text: 'الغاء',
          role: 'cancel',
